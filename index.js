...
const config = {
    ...
    nomer: 'wa.me/6285212830930',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UCGYLWtyT9IADYNUiK0uZiGg',
    whatsapp: 'https://chat.whatsapp.com/I69Fp3OwJVH1sIyytvlo0O',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] Scan kode qr lu!`)
})
...
client.on('message-status-update', json => {
   ...
   console.log(`[ ${time} ] => bot by ig:@ff.kelvin15`)
})
       ...
       case 'ytmp3':
           ytdl('mp3', value)
               .then(data => {
                   ...
                   client.sendMessage(id, '[❗] WAIT tunggu 1 menit🖤', MessageType.text)
